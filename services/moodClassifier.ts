...
const EMOTION_LEXICON: Record<string, { score: number; category: string }> = {
    ...
    'stressée': { score: -5, category: 'stress' },
    'stresse': { score: -5, category: 'stress' },
    ...
    'démotivé': { score: -5, category: 'sadness' },
    'démotivée': { score: -5, category: 'sadness' },
    'découragé': { score: -5, category: 'sadness' },
    'découragée': { score: -5, category: 'sadness' },
    'vide': { score: -4, category: 'sadness' },
    'furieux': { score: -6, category: 'anger' },
    'furieuse': { score: -6, category: 'anger' },
    'rageur': { score: -6, category: 'anger' },
    'agacé': { score: -4, category: 'anger' },
    'irrité': { score: -4, category: 'anger' },
    'débordé': { score: -4, category: 'stress' },
    'submergé': { score: -5, category: 'stress' },
    'accablé': { score: -5, category: 'stress' },
    'tourmenté': { score: -5, category: 'anxiety' },
    'nostalgique': { score: -2, category: 'sadness' },
    'coupable': { score: -4, category: 'guilt' },
    'honteux': { score: -4, category: 'shame' },
    'déçu': { score: -4, category: 'frustration' },
    'abandonné': { score: -5, category: 'loneliness' },
    'incompris': { score: -4, category: 'loneliness' },
    'nul': { score: -5, category: 'sadness' },
    'inutile': { score: -5, category: 'sadness' },
    'overwhelmed': { score: -5, category: 'stress' },
    'unmotivated': { score: -5, category: 'sadness' },
    'lost': { score: -4, category: 'confusion' },
